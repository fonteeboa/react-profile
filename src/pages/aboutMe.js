    ...
    <div className="about-me-container" data-testid="about-me-container">
      <Row className="about-me-content" gutter={[16, 16]}>
        <Col xs={24} md={6} className="about-me-image-col animate__animated animate__bounceInLeft">
          <img src={profileImage} alt="Profile" className="about-me-image zoomImg" data-testid="about-me-img" />
        </Col>
        <Col xs={24} md={18}>
          <Title level={2} className="about-me-title">About Me</Title>
          <Paragraph className="about-me-paragraph" data-testid="about-me-paragraph-1">
          ...
          <Paragraph className="about-me-paragraph" data-testid="about-me-paragraph-2">
